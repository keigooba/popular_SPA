			...
			<Container>
				...
				<Text py="4">
					...
					<UnorderedList>
						...
						<ListItem mb="2">
							（6）「本サービス」とは、当サービス提供者が提供するpopularというフリー画像投稿サービス（理由の如何を問わずサービスの名称又は内容が変更された場合は、当該変更後のサービスを含みます。）を意味します。
						</ListItem>
						<ListItem mb="2">
							（7）「利用契約」とは、第3条第4項に定義される「利用契約」を意味します。
						</ListItem>
						<ListItem mb="2">
							（8）「外部SNSサービス」とは、Twitter、その他の他の事業者が提供している当サービス提供者所定のソーシャル・ネットワーキング・サービスで、登録ユーザーの認証、友人関係の開示、当該外部ソーシャル・ネットワーク内へのコンテンツの公開などの機能を持ち、本サービスの実施に利用されるサービスを意味します。
						</ListItem>
						<ListItem mb="2">
